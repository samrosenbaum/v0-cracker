...
DROP POLICY IF EXISTS "Users can view their agency memberships" ON public.agency_members;
DROP POLICY IF EXISTS "Users can view cases from their agency" ON public.cases;
DROP POLICY IF EXISTS "Users can insert cases to their agency" ON public.cases;
DROP POLICY IF EXISTS "Users can update cases in their agency" ON public.cases;
DROP POLICY IF EXISTS "Users can delete their own cases" ON public.cases;
DROP POLICY IF EXISTS "Users can view case files from their agency cases" ON public.case_files;
DROP POLICY IF EXISTS "Users can insert case files to their agency cases" ON public.case_files;
...
DROP POLICY IF EXISTS "Users can view analysis from their agency cases" ON public.case_analysis;
DROP POLICY IF EXISTS "Users can insert analysis to their agency cases" ON public.case_analysis;
DROP POLICY IF EXISTS "Users can view suspects from their agency cases" ON public.suspects;
DROP POLICY IF EXISTS "Users can manage suspects in their agency cases" ON public.suspects;
DROP POLICY IF EXISTS "Users can view evidence events from their agency cases" ON public.evidence_events;
DROP POLICY IF EXISTS "Users can manage evidence events in their agency cases" ON public.evidence_events;
DROP POLICY IF EXISTS "Users can view quality flags from their agency cases" ON public.quality_flags;
DROP POLICY IF EXISTS "Users can manage quality flags in their agency cases" ON public.quality_flags;
