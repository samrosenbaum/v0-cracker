DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can manage quality flags in their agency cases" ON public.quality_flags CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view quality flags from their agency cases" ON public.quality_flags CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can manage evidence events in their agency cases" ON public.evidence_events CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view evidence events from their agency cases" ON public.evidence_events CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can manage suspects in their agency cases" ON public.suspects CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view suspects from their agency cases" ON public.suspects CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can insert analysis to their agency cases" ON public.case_analysis CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view analysis from their agency cases" ON public.case_analysis CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can insert case documents to their agency cases" ON public.case_documents CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view case documents from their agency cases" ON public.case_documents CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can insert case files to their agency cases" ON public.case_files CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view case files from their agency cases" ON public.case_files CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can delete their own cases" ON public.cases CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can update cases in their agency" ON public.cases CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can insert cases to their agency" ON public.cases CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view cases from their agency" ON public.cases CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view their agency memberships" ON public.agency_members CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;

DO $$
BEGIN
    EXECUTE 'DROP POLICY IF EXISTS "Users can view their agencies" ON public.agencies CASCADE';
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
