DROP POLICY IF EXISTS "Users can manage quality flags in their agency cases" ON public.quality_flags CASCADE;
DROP POLICY IF EXISTS "Users can view quality flags from their agency cases" ON public.quality_flags CASCADE;
DROP POLICY IF EXISTS "Users can manage evidence events in their agency cases" ON public.evidence_events CASCADE;
DROP POLICY IF EXISTS "Users can view evidence events from their agency cases" ON public.evidence_events CASCADE;
DROP POLICY IF EXISTS "Users can manage suspects in their agency cases" ON public.suspects CASCADE;
DROP POLICY IF EXISTS "Users can view suspects from their agency cases" ON public.suspects CASCADE;
DROP POLICY IF EXISTS "Users can insert analysis to their agency cases" ON public.case_analysis CASCADE;
DROP POLICY IF EXISTS "Users can view analysis from their agency cases" ON public.case_analysis CASCADE;
DROP POLICY IF EXISTS "Users can insert case documents to their agency cases" ON public.case_documents CASCADE;
DROP POLICY IF EXISTS "Users can view case documents from their agency cases" ON public.case_documents CASCADE;
DROP POLICY IF EXISTS "Users can insert case files to their agency cases" ON public.case_files CASCADE;
DROP POLICY IF EXISTS "Users can view case files from their agency cases" ON public.case_files CASCADE;
DROP POLICY IF EXISTS "Users can delete their own cases" ON public.cases CASCADE;
DROP POLICY IF EXISTS "Users can update cases in their agency" ON public.cases CASCADE;
DROP POLICY IF EXISTS "Users can insert cases to their agency" ON public.cases CASCADE;
DROP POLICY IF EXISTS "Users can view cases from their agency" ON public.cases CASCADE;
DROP POLICY IF EXISTS "Users can view their agency memberships" ON public.agency_members CASCADE;
DROP POLICY IF EXISTS "Users can view their agencies" ON public.agencies CASCADE;

DROP TRIGGER IF EXISTS set_updated_at ON public.quality_flags;
DROP TRIGGER IF EXISTS set_updated_at ON public.evidence_events;
DROP TRIGGER IF EXISTS set_updated_at ON public.suspects;
DROP TRIGGER IF EXISTS set_updated_at ON public.case_analysis;
DROP TRIGGER IF EXISTS set_updated_at ON public.case_documents;
DROP TRIGGER IF EXISTS set_updated_at ON public.case_files;
DROP TRIGGER IF EXISTS set_updated_at ON public.cases;
DROP TRIGGER IF EXISTS set_updated_at ON public.agencies;

DROP TABLE IF EXISTS public.quality_flags CASCADE;
DROP TABLE IF EXISTS public.evidence_events CASCADE;
DROP TABLE IF EXISTS public.suspects CASCADE;
DROP TABLE IF EXISTS public.case_analysis CASCADE;
...
CREATE INDEX idx_evidence_events_case_id ON public.evidence_events(case_id);
CREATE INDEX idx_quality_flags_case_id ON public.quality_flags(case_id);
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.cases FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.case_files FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.case_documents FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.case_analysis FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.suspects FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.evidence_events FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.quality_flags FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
