...
export default function AnalysisFlagsPage() {
  ...
  <CardContent>
    <form className="flex flex-col gap-4" action="/api/upload" method="POST" encType="multipart/form-data">
      <input type="file" name="file" accept=".pdf,.doc,.docx,.txt" className="block w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-primary file:text-white hover:file:bg-primary/90" />
